    ...
    <div class="form-container">
        ...
        <form action="action/accionNuevoAuto.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Marca" name="Marca" placeholder="Ingrese la marca del auto" required>
            </div>

            <div class="mb-3">
                <label for="Modelo" class="form-label">Modelo:</label>
                <input type="number" class="form-control" id="Modelo" name="Modelo" placeholder="Ingrese el modelo del auto" required>
            </div>

            <div class="mb-3">
                <label for="DniDuenio" class="form-label">DNI del Dueño:</label>
                <input type="number" class="form-control" id="DniDuenio" name="DniDuenio" placeholder="Ingrese el DNI del dueño" required>
            </div>
