...
<body>
    ...
    <div class="form-container">
        ...
        <form action="action/accionBuscarPersona.php" method="post">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="NroDni" name="NroDni" placeholder="Ingrese el DNI" required>
            </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js"
        integrity="sha384-oBqDVmMz4fnFO9gybHY8bMgvS+7r3DLMw5yyLsE2y15nDjbx1+tSRVG9C9s1H/tt" crossorigin="anonymous"></script>
